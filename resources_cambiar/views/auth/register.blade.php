    ...
    <div class="column is-half is-offset-one-quarter m-t-45">
      <div class="card">
        <div class="card-content">
          <h1 class="title">Registra tu Cuenta de Usuario</h1>
          ...
          <form action="{{route('register')}}" method="POST" role="form">
            ...
            <div class="columns">
              ...
              <div class="column">
                <div class="field">
                  <label for="password_confirmation" class="label">Confirmar Clave</label>
                  <p class="control">
            ...
            <button class="button is-success is-outlined is-fullwidth m-t-30">Crear Cuenta de Usuario</button>
          </form>
        </div> <!-- end of .card-content -->
      </div> <!-- end of .card -->
      <h5 class="has-text-centered m-t-20"><a href="{{route('login')}}" class="is-muted">Ya tienes una cuenta?</a></h5>
    </div>
  </div>
