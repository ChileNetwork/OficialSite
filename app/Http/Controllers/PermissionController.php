...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
      if ($request->permission_type == 'basic') {
        ...
        Session::flash('success', 'Los permisos fueron creados correctamente');
        ...
        if (count($crud) > 0) {
          foreach ($crud as $x) {
            ...
            $description = "Permite al usuario a " . strtoupper($x) . ' a ' . ucwords($request->resource);
    ...
    public function update(Request $request, $id)
    {
      ...
      Session::flash('success', 'Actualizar permiso '. $permission->display_name);
